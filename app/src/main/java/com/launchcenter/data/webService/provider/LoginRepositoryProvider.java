...
public class LoginRepositoryProvider {
    ...
    public Observable<AccountResponse> contactUs(ContactUsModel contactUsModel) {
        RegisterDataService dataService = RetrofitInstance.getService();
        return dataService.ContactUs(contactUsModel.getName(),contactUsModel.getEmail(), contactUsModel.getMessage());
    }
}
